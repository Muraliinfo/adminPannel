...
module.exports = {
    db: {
        uri: process.env.MONGOHQ_URL || process.env.MONGODB_URI || 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost') + '/mymean',
        options: {},
    ...
    google: {
        clientID: '418315275005-ogc84np1uq0fnrcv6bmq9apaaf942833.apps.googleusercontent.com',
        clientSecret: '83gxWl1UWG7DGzP4bMBQoD-e',
